...
switch ($layout_menu) {
    case "gerencia":
        $nav_position = 1;
        $color_theme = "theme_red.css";
        break;
    case "callcenter":
        $nav_position = 2;
        $color_theme = "theme_blue.css";
        break;
    case "cadastro":
        $nav_position = 3;
        $color_theme = "theme_navy.css";
        break;
    case "tecnica":
        $nav_position = 4;
        $color_theme = "theme_magenta.css";
        break;
    case "financeiro":
        $nav_position = 5;
        $color_theme = "theme_green.css";
        break;
    case "auditoria":
        $nav_position = 6;
        $color_theme = "theme_brown.css";
        break;

    default:
        $color_theme = "switcher.css";
        break;
}
